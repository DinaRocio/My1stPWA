export default async () => {
  ...
  swRegistration.addEventListener("updatfound", ()=>{
  ...
  //Un evento extra que el lanzado cuando el Service Worker que controla 
  // esta página cambia, a través del self.skipWaiting();
